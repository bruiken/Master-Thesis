...
\begin{figure}
    ...
    \begin{tikzpicture}
        ...
        \node[draw,align=left] (ES) at (6,0) {\texttt{\#ifdef A} \\ \texttt{  do\_something\_different()} \\ \texttt{\#else} \\ \texttt{  do\_something\_else()} \\ \texttt{\#endif}};
        \node[draw,align=left] (OV) at (0,-4) {\texttt{\#ifdef A} \\ \texttt{  do\_something()} \\ \texttt{\#else} \\ \texttt{  do\_something\_else()} \\ \texttt{\#endif}};
        \node[draw,align=left] (EV) at (6,-4) {\texttt{\#ifdef A} \\ \texttt{  do\_something\_different()} \\ \texttt{\#else} \\ \texttt{  do\_something\_else()} \\ \texttt{\#endif}};            
